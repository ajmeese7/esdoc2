...
var ASTUtil = function () {
  ...
  _createClass(ASTUtil, null, [{
    ...
    value: function findVariableDeclarationAndNewExpressionNode(name, ast) {
      ...
      try {
        for (var _iterator2 = ast.program.body[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function findClassDeclarationNode(name, ast) {
      ...
      try {
        for (var _iterator3 = ast.program.body[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    value: function findFunctionDeclarationNode(name, ast) {
      ...
      try {
        for (var _iterator4 = ast.program.body[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    value: function findVariableDeclarationNode(name, ast) {
      ...
      try {
        for (var _iterator5 = ast.program.body[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
