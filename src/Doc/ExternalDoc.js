...
var ExternalDoc = function (_AbstractDoc) {
  ...
  _createClass(ExternalDoc, [{
    ...
    value: function _$kind() {
      _get(ExternalDoc.prototype.__proto__ || Object.getPrototypeOf(ExternalDoc.prototype), "_$kind", this).call(this);
    ...
    value: function _$name() {
      var value = this._findTagValue(["@external"]);
      if (!value) {
      ...
      var tags = this._findAll(["@external"]);
      if (!tags) {
        _npmlog2.default.warn("can not resolve name.");
        return;
      }
      ...
      try {
        for (var _iterator = tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var _ParamParser$parsePar = _ParamParser2.default.parseParamValue(tag.tagValue, true, false, true),
    ...
    value: function _$memberof() {
      _get(ExternalDoc.prototype.__proto__ || Object.getPrototypeOf(ExternalDoc.prototype), "_$memberof", this).call(this);
    ...
    value: function _$longname() {
      _get(ExternalDoc.prototype.__proto__ || Object.getPrototypeOf(ExternalDoc.prototype), "_$longname", this).call(this);
